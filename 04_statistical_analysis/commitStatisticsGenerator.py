...
class CommitStatisticsGenerator:
    ...
    def get_all_commits_count():
        ...
        adoption_commits = 0
        adoption = RESOURCES_DIR / 'adoption_commits.json'
        ...
        migration_commits = 0
        migration = RESOURCES_DIR / 'migration_commits.json'
    ...
    def get_commits_after_filtering_count():
        adoption =  RESOURCES_DIR / 'adoption_commits_filtered.xlsx'
        df = pd.read_excel(adoption)

        migration =  RESOURCES_DIR / 'migration_commits_filtered.xlsx'
    ...
    def generate_side_by_side_pie_charts():
        ...
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'commits_statistics.svg', bbox_inches='tight')
