...
from core.config import RESOURCES_DIR, ROOT_DIR
...
class StatisticsGenerator:
    ...
    def adoption_counts_by_framework():
        ...
        for bar in bars:
            ...
            ax.annotate('{}'.format(width),
                        ...
                        ha='left', va='center')
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'adoption_by_framework.svg', bbox_inches='tight')

        # Save the figure
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'migration_flows.svg', bbox_inches='tight')
    ...
    def migration_directed_graph():
        ...
        plt.axis('off')
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / "migration_directed_graph.svg", bbox_inches='tight')
        plt.close()
    ...
    def migration_sankey_diagram():
        ...
        # Save as SVG
        svg_path = ROOT_DIR / '04_statistical_analysis' / "migration_sankey_diagram.svg"
    ...
    def motivation_category_distribution():
        ...
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'motivation_category_distribution.svg', bbox_inches='tight')  
        plt.close()
    ...
    def grouped_bar_chart_motivation_category():
        ...
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'adoption_vs_migration_motivation_distribution.svg', bbox_inches='tight')
        plt.close()
    ...
    def playwright_migration_sources():
        ...
        ax.axis('equal')  # Equal aspect ratio ensures that pie is drawn as a circle.
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'playwright_migration_sources.svg', bbox_inches='tight')
        plt.close()
    ...
    def generate_side_by_side_pie_charts():
        ...
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'adoption_vs_migration_distribution.svg', bbox_inches='tight')
        plt.close()
    ...
    def target_framework_by_language():
        ...
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'target_framework_by_language.svg', bbox_inches='tight')
        plt.close()
    ...
    def transitions_timeline_scatter():
        ...
        plt.tight_layout()
        plt.savefig(ROOT_DIR / '04_statistical_analysis' / 'transitions_timeline_scatter.svg', bbox_inches='tight')
        plt.close()
